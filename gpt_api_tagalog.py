...
def generate_prompt(text):
    return """Translate the mix of English and Tagalog words into English based on the context of the English text. The output should be English. In cases where the text is purely tagalog, translate it into english with proper grammar. In cases where the text is purely english, just use the input as the output.
